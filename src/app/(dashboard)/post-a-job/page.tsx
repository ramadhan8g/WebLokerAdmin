...
const PostJobPage: FC<PostJobPageProps> = ({ }) => {
  // useSWR:yang memungkinkan pengambilan, cache, atau pengambilan ulang data secara realtime menggunakan React Hooks.
  ...
  // z.infer utk extract type
  // zodresolver  fungsi penyelesai yang mengintegrasikan validasi skema Zod dengan proses validasi formulir.
